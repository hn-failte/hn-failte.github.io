...
语法：
[![github](https://img.shields.io/badge/github-xugaoyi-brightgreen.svg)](https://github.com/hn-failte)
```
[![github](https://img.shields.io/badge/github-xugaoyi-brightgreen.svg)](https://github.com/hn-failte)
...
```markdown
![其他仓库的图片1](https://github.com/hn-failte/vue-music/raw/master/src/common/image/default.png)
或
...
![其他仓库的图片](https://github.com/hn-failte/vue-music/raw/master/src/common/image/default.png)
